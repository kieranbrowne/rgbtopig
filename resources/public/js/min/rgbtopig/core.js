...
return (fexpr__13724.cljs$core$IFn$_invoke$arity$1 ? fexpr__13724.cljs$core$IFn$_invoke$arity$1(whitebalance) : fexpr__13724.call(null,whitebalance));
})())),")"].join('');
});
...
var whitebalance = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13725__$1,cljs.core.cst$kw$whitebalance);
var rgb = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13725__$1,cljs.core.cst$kw$rgb);
return ["rgb(",cljs.core.str.cljs$core$IFn$_invoke$arity$1(clojure.string.join.cljs$core$IFn$_invoke$arity$2(",",cljs.core.map.cljs$core$IFn$_invoke$arity$3(((function (map__13725,map__13725__$1,whitebalance,rgb){
return (function (v,wb){
return (v * (wb / (255)));
});})(map__13725,map__13725__$1,whitebalance,rgb))
,(function (){var fexpr__13727 = cljs.core.juxt.cljs$core$IFn$_invoke$arity$3(cljs.core.cst$kw$r,cljs.core.cst$kw$g,cljs.core.cst$kw$b);
...
})(),(function (){var fexpr__13728 = cljs.core.juxt.cljs$core$IFn$_invoke$arity$3(cljs.core.cst$kw$r,cljs.core.cst$kw$g,cljs.core.cst$kw$b);
return (fexpr__13728.cljs$core$IFn$_invoke$arity$1 ? fexpr__13728.cljs$core$IFn$_invoke$arity$1(whitebalance) : fexpr__13728.call(null,whitebalance));
})()))),")"].join('');
});
rgbtopig.core.text_colour = (function rgbtopig$core$text_colour(state){
var map__13729 = cljs.core.deref(state);
var map__13729__$1 = ((((!((map__13729 == null)))?((((map__13729.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__13729.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__13729):map__13729);
var rgb = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13729__$1,cljs.core.cst$kw$rgb);
if((cljs.core.reduce.cljs$core$IFn$_invoke$arity$2(cljs.core._PLUS_,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.int$,(function (){var fexpr__13731 = cljs.core.juxt.cljs$core$IFn$_invoke$arity$3(cljs.core.cst$kw$r,cljs.core.cst$kw$g,cljs.core.cst$kw$b);
return (fexpr__13731.cljs$core$IFn$_invoke$arity$1 ? fexpr__13731.cljs$core$IFn$_invoke$arity$1(rgb) : fexpr__13731.call(null,rgb));
})())) > ((255) * (2)))){
return "black";
} else {
return "white";
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(atom,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,(function (p1__13732_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(id,cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(p1__13732_SHARP_))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__13732_SHARP_,cljs.core.cst$kw$pig,event.target.value);
} else {
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(atom,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,(function (p1__13733_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(id,cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(p1__13733_SHARP_))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__13733_SHARP_,cljs.core.cst$kw$grams,event.target.value);
} else {
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(ratom,(function (p1__13734_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__13734_SHARP_,cljs.core.cst$kw$show_DASH_whitebalance,false);
}));
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(ratom,(function (p1__13735_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__13735_SHARP_,cljs.core.cst$kw$show_DASH_whitebalance,true);
}));
})], null),"adjust whitebalance"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$h2,"Pigments"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$pig,(function (){var iter__8476__auto__ = (function rgbtopig$core$form_$_iter__13736(s__13737){
return (new cljs.core.LazySeq(null,(function (){
var s__13737__$1 = s__13737;
while(true){
var temp__4657__auto__ = cljs.core.seq(s__13737__$1);
if(temp__4657__auto__){
var s__13737__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_(s__13737__$2)){
var c__8474__auto__ = cljs.core.chunk_first(s__13737__$2);
var size__8475__auto__ = cljs.core.count(c__8474__auto__);
var b__13739 = cljs.core.chunk_buffer(size__8475__auto__);
if((function (){var i__13738 = (0);
while(true){
if((i__13738 < size__8475__auto__)){
var p = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__8474__auto__,i__13738);
cljs.core.chunk_append(b__13739,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$input,new cljs.core.PersistentArrayMap(null, 5, [cljs.core.cst$kw$type,"text",cljs.core.cst$kw$placeholder,"Pigment Code",cljs.core.cst$kw$value,cljs.core.cst$kw$pig.cljs$core$IFn$_invoke$arity$1(p),cljs.core.cst$kw$style,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$color,rgbtopig.core.text_colour(rgbtopig.core.app_state),cljs.core.cst$kw$border_DASH_color,rgbtopig.core.text_colour(rgbtopig.core.app_state)], null),cljs.core.cst$kw$on_DASH_change,cljs.core.partial.cljs$core$IFn$_invoke$arity$3(rgbtopig.core.rename_pig,reagent.core.cursor(ratom,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$pigs], null)),cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(p))], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$input,new cljs.core.PersistentArrayMap(null, 5, [cljs.core.cst$kw$type,"number",cljs.core.cst$kw$placeholder,"grams",cljs.core.cst$kw$value,cljs.core.cst$kw$grams.cljs$core$IFn$_invoke$arity$1(p),cljs.core.cst$kw$style,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$color,rgbtopig.core.text_colour(rgbtopig.core.app_state),cljs.core.cst$kw$border_DASH_color,rgbtopig.core.text_colour(rgbtopig.core.app_state)], null),cljs.core.cst$kw$on_DASH_change,cljs.core.partial.cljs$core$IFn$_invoke$arity$3(rgbtopig.core.change_weight_pig,reagent.core.cursor(ratom,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$pigs], null)),cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(p))], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$span,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$style,new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$font_DASH_size,"40px",cljs.core.cst$kw$line_DASH_height,"32px",cljs.core.cst$kw$margin_DASH_left,"10px",cljs.core.cst$kw$vertical_DASH_align,"top"], null),cljs.core.cst$kw$on_DASH_click,((function (i__13738,p,c__8474__auto__,size__8475__auto__,b__13739,s__13737__$2,temp__4657__auto__){
return (function (){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(reagent.core.cursor(ratom,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$pigs], null)),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.filter,((function (i__13738,p,c__8474__auto__,size__8475__auto__,b__13739,s__13737__$2,temp__4657__auto__){
return (function (x){
...
});})(i__13738,p,c__8474__auto__,size__8475__auto__,b__13739,s__13737__$2,temp__4657__auto__))
));
});})(i__13738,p,c__8474__auto__,size__8475__auto__,b__13739,s__13737__$2,temp__4657__auto__))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__13739),rgbtopig$core$form_$_iter__13736(cljs.core.chunk_rest(s__13737__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__13739),null);
}
} else {
var p = cljs.core.first(s__13737__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$input,new cljs.core.PersistentArrayMap(null, 5, [cljs.core.cst$kw$type,"text",cljs.core.cst$kw$placeholder,"Pigment Code",cljs.core.cst$kw$value,cljs.core.cst$kw$pig.cljs$core$IFn$_invoke$arity$1(p),cljs.core.cst$kw$style,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$color,rgbtopig.core.text_colour(rgbtopig.core.app_state),cljs.core.cst$kw$border_DASH_color,rgbtopig.core.text_colour(rgbtopig.core.app_state)], null),cljs.core.cst$kw$on_DASH_change,cljs.core.partial.cljs$core$IFn$_invoke$arity$3(rgbtopig.core.rename_pig,reagent.core.cursor(ratom,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$pigs], null)),cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(p))], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$input,new cljs.core.PersistentArrayMap(null, 5, [cljs.core.cst$kw$type,"number",cljs.core.cst$kw$placeholder,"grams",cljs.core.cst$kw$value,cljs.core.cst$kw$grams.cljs$core$IFn$_invoke$arity$1(p),cljs.core.cst$kw$style,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$color,rgbtopig.core.text_colour(rgbtopig.core.app_state),cljs.core.cst$kw$border_DASH_color,rgbtopig.core.text_colour(rgbtopig.core.app_state)], null),cljs.core.cst$kw$on_DASH_change,cljs.core.partial.cljs$core$IFn$_invoke$arity$3(rgbtopig.core.change_weight_pig,reagent.core.cursor(ratom,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$pigs], null)),cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(p))], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$span,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$style,new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$font_DASH_size,"40px",cljs.core.cst$kw$line_DASH_height,"32px",cljs.core.cst$kw$margin_DASH_left,"10px",cljs.core.cst$kw$vertical_DASH_align,"top"], null),cljs.core.cst$kw$on_DASH_click,((function (p,s__13737__$2,temp__4657__auto__){
return (function (){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(reagent.core.cursor(ratom,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$pigs], null)),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.filter,((function (p,s__13737__$2,temp__4657__auto__){
return (function (x){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(p),cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(x));
});})(p,s__13737__$2,temp__4657__auto__))
));
});})(p,s__13737__$2,temp__4657__auto__))
], null),"\u00D7"], null)], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(p)], null)),rgbtopig$core$form_$_iter__13736(cljs.core.rest(s__13737__$2)));
}
} else {
return null;
}
...
}),cljs.core.cst$kw$style,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$font_DASH_size,"40px",cljs.core.cst$kw$border_DASH_color,rgbtopig.core.text_colour(rgbtopig.core.app_state)], null)], null),"+"], null)], null)], null);
});
